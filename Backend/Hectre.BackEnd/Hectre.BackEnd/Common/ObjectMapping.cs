...
{
    /// <summary>
    /// Util class provides methods to map value from an object to other object based on there field/property names & types
    /// </summary>
    public static class ObjectMapping
    {
        ...
        public static T MapTo<T>(this object message, Dictionary<string, string> exclusiveMapping = null,
            List<string> ignoreFields = null) where T : class
        {
            var t = Activator.CreateInstance(typeof(T));
            return message.MapTo((T)t, exclusiveMapping, ignoreFields);
        }
